...
<input type="hidden" name="hosted_button_id" value="JULRSEGJGJE88">
<table>
<tr><td><input type="hidden" name="on0" value="Membershio"></td></tr><tr><td><select name="os0">

	<option value="One Month">One Month 100.00 EUR</option>
	<option value="Six Months">Six Months 300.00 EUR</option>
	<option value="One Year">One Year 550.00 EUR</option>
</select> </td></tr>
</table>
